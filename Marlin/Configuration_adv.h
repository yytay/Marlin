...
#define HOMING_BUMP_MM      { 5, 20, 0 }       // (mm) Backoff from endstops after first bump
...
#define ADVANCED_PAUSE_FEATURE
  ...
  // #define PAUSE_PARK_RETRACT_FEEDRATE         6  // (mm/s) Initial retract feedrate. for SK-Swift
  ...
  // #define FILAMENT_CHANGE_FAST_LOAD_FEEDRATE   6  // for SK-Swift. (mm/s) Load filament feedrate. This can be pretty fast.
  ...
  // #define FILAMENT_UNLOAD_PURGE_FEEDRATE      6  // for SK-Swift. (mm/s) feedrate to purge before unload
 ...
 */
  ...
  #define INTERPOLATE       true  // Interpolate X/Y/Z_MICROSTEPS to 256
    ...
    // #define E0_CURRENT      500   // for SK-Swift
...
//#define LASER_FEATURE
  ...
  #define SPINDLE_LASER_POWERDOWN_DELAY 5000   // (ms) Delay to allow the spindle to stop
     ...
     *
     *  SPEED/POWER = PWM duty cycle * SPEED_POWER_INTERCEPT + SPEED_POWER_INTERCEPT
     *    where PWM duty cycle varies from 0 to 255
     *
     *  set the following for your controller (ALL MUST BE SET)
     */
    #define SPEED_POWER_INTERCEPT    118.4
    #define SPEED_POWER_INTERCEPT  0
    #define SPEED_POWER_MIN     5000
    #define SPEED_POWER_MAX    30000    // SuperPID router controller 0 - 30,000 RPM
  #else
    #define SPEED_POWER_INTERCEPT      0.3922
    #define SPEED_POWER_INTERCEPT  0
